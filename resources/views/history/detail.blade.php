        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out. Selanjutnya untuk pembayaran silahkan transfer di rekening <br><strong>Nomor Rekening : 0314-0103-0961-500 (BRI) </strong><br> Atas nama: <strong>Erwin Marbinoto Tamba</strong> <br>dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
